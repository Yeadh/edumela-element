...
// Accordion
class edumela_Widget_Accordion extends Widget_Base {
   ...
   public function get_title() {
      return esc_html__( 'Accordion', 'edumela' );
   }
   ...
   protected function _register_controls() {
      ...
      $this->start_controls_section(
         'accordion_section',
         [
            'label' => esc_html__( 'Accordion', 'edumela' ),
      ...
      $this->add_control(
         'accordion_list',
         [
            'label' => __( 'Accordion list', 'edumela' ),
            'type' => \Elementor\Controls_Manager::REPEATER,
            'fields' => $accordion->get_controls(),
            'default' => [
               [
                  'title' => __( 'Lorem ipsum dummy text used here?', 'edumela' ),
                  'text' => __( 'Lorem ipsum dolor sit amet, vix an natum labitur eleifd, mel am laoreet menandri. Ei justo complectitur duo. Ei mundi solet utos soletu possit quo. Sea cu justo laudem.', 'edumela' )
               ],
               [
                  'title' => __( 'Why i should buy this Theme?', 'edumela' ),
                  'text' => __( 'Lorem ipsum dolor sit amet, vix an natum labitur eleifd, mel am laoreet menandri. Ei justo complectitur duo. Ei mundi solet utos soletu possit quo. Sea cu justo laudem.', 'edumela' )
               ],
               [
                  'title' => __( 'Can i change any elements easilly?', 'edumela' ),
                  'text' => __( 'Lorem ipsum dolor sit amet, vix an natum labitur eleifd, mel am laoreet menandri. Ei justo complectitur duo. Ei mundi solet utos soletu possit quo. Sea cu justo laudem.', 'edumela' )
               ]
            ],
            'title_field' => '{{{ title }}}',
...
Plugin::instance()->widgets_manager->register_widget_type( new edumela_Widget_Accordion );