...
// Features
class edumela_Widget_ExFeatures extends Widget_Base {
   ...
   public function get_title() {
      return esc_html__( 'Exclusive Features', 'edumela' );
   }
   ...
   protected function _register_controls() {
      ...
      $this->start_controls_section(
         'features',
         [
            'label' => esc_html__( 'Exclusive Features', 'edumela' ),
      ...
      'bg_color_1',
        [
          'label' => __( 'Gradient Color 1', 'edumela' ),
      ...
      'bg_color_2',
        [
          'label' => __( 'Gradient Color 2', 'edumela' ),
          'type' => \Elementor\Controls_Manager::COLOR,
          'scheme' => [
            'type' => \Elementor\Scheme_Color::get_type(),
            'value' => \Elementor\Scheme_Color::COLOR_1,
      ...
      $this->add_control(
         ...
         [
            ...
            'default' => __('Exclusive Features','edumela')
         ]
      );
      ...
      $this->add_control(
         ...
         [
            ...
            'type' => \Elementor\Controls_Manager::TEXT,
            'default' => __('Lorem ipsum dummy text are used here so replace your app data','edumela')
         ]
      );
...
Plugin::instance()->widgets_manager->register_widget_type( new edumela_Widget_ExFeatures );