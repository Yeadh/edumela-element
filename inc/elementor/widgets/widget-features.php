...
// Features
class edumela_Widget_Features extends Widget_Base {
   ...
   public function get_title() {
      return esc_html__( 'Features', 'edumela' );
   }
   ...
   protected function _register_controls() {
      ...
      $this->start_controls_section(
         'features',
         [
            'label' => esc_html__( 'Features', 'edumela' ),
      ...
      $this->add_control(
         'button_text', [
            ...
            'type' => \Elementor\Controls_Manager::TEXT,
            'default' => __('View all features','edumela')
         ]
      );
...
Plugin::instance()->widgets_manager->register_widget_type( new edumela_Widget_Features );