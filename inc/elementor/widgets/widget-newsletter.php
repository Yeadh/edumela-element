...
// Newsletter
class edumela_Widget_newsletter extends Widget_Base {
   ...
   public function get_title() {
      return esc_html__( 'Newsletter', 'edumela' );
   }
   ...
   protected function _register_controls() {
      ...
      $this->start_controls_section(
         'newsletter_section',
         [
            'label' => esc_html__( 'Newsletter', 'edumela' ),
      ...
      $this->add_control(
         'title', [
            ...
            'default' => __( 'Get reguler updates', 'edumela' ),
         ]
      );
      ...
      $this->add_control(
         'desc', [
            ...
            'default' => __( 'Lorem ipsum dummy text are used here so replace your app data, Lorem ipsm', 'edumela' ),
         ]
      );
      ...
      $this->add_control(
         'shortcode', [
            ...
            'type' => \Elementor\Controls_Manager::TEXTAREA,
            'placeholder' => __( '[mc4wp_form id="123"]', 'edumela' ),
         ]
      );

      $this->add_control(
         'background', [
            'label' => __( 'Floating Image', 'edumela' ),
...
Plugin::instance()->widgets_manager->register_widget_type( new edumela_Widget_newsletter );