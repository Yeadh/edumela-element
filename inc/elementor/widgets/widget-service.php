...
// service item
class edumela_Widget_Service extends Widget_Base {
   ...
   public function get_title() {
      return esc_html__( 'Service Item', 'edumela' );
   }
   ...
   protected function _register_controls() {
      $this->start_controls_section(
         'service_section',
         [
            'label' => esc_html__( 'Service Item', 'edumela' ),
      ...
      $this->add_control(
         ...
         [
            ...
            'default' => __('Awesome Design','edumela'),
         ]
      );
      $this->add_control(
         'text',
         [
            ...
            'default' => __('Lorem ipsum dummy text are used here so replace your app data, ipsum dummy text are used here so','edumela'),
         ]
      );
      ...
      $this->add_control(
         'style',
         [
            'label' => __( 'Service Style', 'edumela' ),
            'type' => \Elementor\Controls_Manager::SELECT,
            'default' => 'center',
            'options' => [
               'center'  => __( 'Center Icon', 'edumela' ),
               'left' => __( 'Left Icon', 'edumela' ),
            ],
         ]
      );
...
Plugin::instance()->widgets_manager->register_widget_type( new edumela_Widget_Service );